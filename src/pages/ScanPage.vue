		...
		<div class="relative">
			...
			<Transition name="fade-slide" appear>
				...
				>
					...
					>
						<path
							d="M157.522 1H201V46.4545"
							stroke="#fff"
							stroke-width="6"
							stroke-linecap="round"
						/>
						<path
							d="M44.4781 201L0.999905 201L0.999908 155.545"
							stroke="#fff"
							stroke-width="6"
							stroke-linecap="round"
						/>
						<path
							d="M1 46.4545L0.999998 0.99999L44.4782 0.999988"
							stroke="#fff"
							stroke-width="6"
							stroke-linecap="round"
						/>
						<path
							d="M201 155.545L201 201L157.522 201"
							stroke="#fff"
							stroke-width="6"
							stroke-linecap="round"
						/>
			...
			<video
				...
				class="hidden"
			></video>
			<canvas ref="canvas" class="bg-black w-full pt-[7vh] h-[85vh]"></canvas>
				...
				>
					<div class="bg-white p-6 rounded-lg w-full max-w-md">
						...
						<p>
							...
							{{
								resultDisease
									? classes.find(c => c.id === resultDisease)?.treatment || 'Консультация с агрономом'
									: plantsStore.leafResult?.disease?.treatment
							}}
						</p>
						<p>
							...
							{{
								resultDisease
									? classes.find(c => c.id === resultDisease)?.prevention || 'Регулярный осмотр растений'
			...
			<Transition name="fade-slide" appear>
			<div
				class="fixed bottom-[170px] left-1/2 -translate-x-1/2 z-10 flex items-center justify-center"
			>
				<div class="relative bg-gray-800 bg-opacity-80 rounded-full p-1 flex items-center">
				<div
					class="absolute h-[90%] w-[50%] rounded-full bg-[#129C52] transition-transform duration-300 ease-in-out"
					:style="{ transform: is_diagnostic ? 'translateX(100%)' : 'translateX(0)' }"
				></div>
				<button
					@click="is_diagnostic = false"
					class="relative z-10 px-4 py-2 text-white text-[1.5vh] font-medium transition-colors duration-300"
					:class="{ 'text-gray-300': is_diagnostic }"
				>
					Идентифицикация
				</button>
				<button
...
const classes = [
	{
		...
		treatment:
			'Применение фунгицидов (например, сера, каптан), удаление поражённых листьев и плодов',
		prevention:
			'Обработка деревьев до цветения, санитарная обрезка, уборка опавших листьев',
	},
	{
		id: 2,
		...
		prevention:
			'Регулярная уборка опавших листьев, избегание чрезмерного полива',
	},
	{
		id: 3,
		name: 'Яблоко___Ржавчина кедрово-яблонная',
		treatment:
			'Применение фунгицидов (миклобутанил), удаление близлежащих кедров, если возможно',
		prevention:
			'Контроль за растениями-хозяевами (кедр, можжевельник), своевременная обрезка',
	},
	{
		id: 4,
	...
	},
	{
		...
		treatment: 'Лечение не требуется',
		prevention:
			'Поддержание кислой почвы, регулярный полив, защита от вредителей',
	},
	{
		id: 6,
	...
	},
	{
		...
		treatment:
			'Применение фунгицидов (сера, триадимефон), удаление поражённых побегов',
		prevention:
			'Обеспечение хорошей вентиляции кроны, избегание переувлажнения',
	},
	{
		id: 8,
		name: 'Кукуруза (маис)___Пятнистость листьев цероспороз Серая пятнистость листьев',
		treatment:
			'Применение фунгицидов (азоксистробин), удаление поражённых остатков',
		prevention:
			'Севооборот, использование устойчивых сортов, уборка растительных остатков',
	},
	{
		id: 9,
		...
		prevention:
			'Использование устойчивых сортов, севооборот, контроль влажности',
	},
	{
		id: 10,
	...
	},
	{
		...
		prevention:
			'Севооборот, использование устойчивых гибридов, уборка остатков',
	},
	{
		id: 12,
		name: 'Виноград___Чёрная гниль',
		treatment:
			'Удаление поражённых ягод и листьев, применение фунгицидов (каптан)',
		prevention:
			'Санитарная обрезка, обеспечение вентиляции кустов, уборка остатков',
	},
	{
		id: 13,
		name: 'Виноград___Эска (чёрная короста)',
		treatment:
			'Применение фунгицидов (миклобутанил), удаление поражённых частей',
		prevention:
			'Обработка до цветения, хорошая вентиляция, уборка опавших листьев',
	},
	{
		id: 14,
	...
	},
	{
		...
		treatment:
			'Удаление заражённых деревьев, контроль насекомых-переносчиков (псиллиды)',
		prevention:
			'Использование здорового посадочного материала, мониторинг насекомых',
	},
	{
		id: 17,
		name: 'Персик___Бактериальное пятно',
		treatment:
			'Применение бактерицидов (медьсодержащие препараты), удаление поражённых ветвей',
	...
	},
	{
		...
		treatment:
			'Применение медьсодержащих препаратов, удаление поражённых листьев',
		prevention:
			'Севооборот, использование здоровых семян, избегание переувлажнения',
	},
	{
		id: 20,
	...
	},
	{
		...
		treatment:
			'Применение фунгицидов (хлороталонил), удаление поражённых растений',
	...
	},
	{
		...
		treatment: 'Лечение не требуется',
		prevention:
			'Севооборот, использование здорового посадочного материала, подкормка',
	},
	{
		id: 23,
		...
		prevention:
			'Севооборот, использование устойчивых сортов, контроль влажности',
	},
	{
		id: 24,
	...
	},
	{
		...
		treatment:
			'Применение фунгицидов (сера, триадимефон), удаление поражённых листьев',
	...
	},
	{
		...
		treatment: 'Применение фунгицидов, удаление поражённых листьев',
		prevention:
			'Севооборот, использование здоровых саженцев, контроль влажности',
	},
	{
		id: 29,
	...
	},
	{
		...
		treatment:
			'Применение фунгицидов (азоксистробин), удаление поражённых листьев',
		prevention: 'Обеспечение вентиляции, избегание переувлажнения, севооборот',
	},
	{
		id: 34,
		...
		treatment:
			'Применение фунгицидов (хлороталонил), удаление поражённых листьев',
	...
	},
	{
		...
		treatment:
			'Применение акарицидов, повышение влажности, удаление поражённых листьев',
		prevention:
			'Регулярный осмотр, поддержание высокой влажности, биологический контроль',
	},
	{
		id: 36,
	...
	},
	{
		...
		prevention:
			'Использование устойчивых сортов, контроль насекомых-переносчиков',
	},
	{
		id: 38,
...
const handleSwipe = (element) => {
  ...
  const onTouchEnd = (e) => {
    ...
    if (touchEndX < touchStartX - 50) {
      is_diagnostic.value = true // Свайп влево -> Диагностика
    } else if (touchEndX > touchStartX + 50) {
      is_diagnostic.value = false // Свайп вправо -> Идентификация
    }
  }
...
onMounted(() => {
	...
	if (switchContainer) {
		const cleanupSwipe = handleSwipe(switchContainer)
		onUnmounted(cleanupSwipe)
	}
...
/* Стили для слайдерного переключателя */
.switch-container {
  touch-action: pan-y; /* Предотвращает скролл при свайпе */
}

.switch-button {
  min-width: 100px; /* Фиксированная ширина для кнопок */
  text-align: center;
}

/* Анимация для слайдера */
.switch-container .bg-[#129C52]  {
