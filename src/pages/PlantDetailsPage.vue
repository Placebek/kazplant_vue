  ...
  <div class="min-h-screen">
    ...
    <div class="absolute top-4 left-3 z-20">
      <router-link to="/plant">
        <button class="bg-white p-2 rounded-full shadow-md transition-all duration-300">
          <svg
        ...
        <div class="p-4 rounded-t-[20px] top-[28vh] absolute bg-white">
          ...
          >
            ...
            <div class="flex flex-col gap-5">
              <p class="text-[1.8vh] font-semibold">Хотите обнаружить больше?</p>
              <div
        ...
        >
          <div class="bg-white p-6 rounded-lg max-w-md w-[80vw] text-center">
            ...
            <div v-else-if="segmentedData || segmentationError">
              ...
              <p v-if="segmentationError" class="text-red-500 mb-4">{{ segmentationError }}</p>
...
onMounted(() => {
  ...
  window.displaySegmentedImage = (base64Image) => {
    if (base64Image) {
      ...
      segmentationLoading.value = false;
      segmentationError.value = 'Не удалось получить сегментированное изображение';
    }
  };
});
