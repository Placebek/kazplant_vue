<template>
  <div class="min-h-screen bg-white">
    ...
    <div class="relative flex justify-center">
      <img src="@/assets/img/auth/register.png" alt="register" class="w-[282px] h-[245px]" />
    </div>
    ...
    <!-- Footer -->
    <div
      class="absolute bottom-0 bg-[#E8F3F2] w-full h-[80px] flex justify-center flex-row gap-2 items-center"
    >
