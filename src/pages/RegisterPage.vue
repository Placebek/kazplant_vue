<template>
  <div class="min-h-screen">
    <!-- Back button -->
    <router-link to="/home" class="relative z-10 top-4 left-4">
      <button>
    ...
    <div class="absolute top-0 left-0">
      <svg width="412" height="358" viewBox="0 0 412 358" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="73.5" cy="-17.5" r="375.5" fill="#73c3b8" />
        <defs>
          <radialGradient
    ...
    <!-- Register image -->
    <div class="relative top-0 w-[282px] h-[245px]">
      <img src="@/assets/img/auth/register.png" alt="register" />
    </div>

    <!-- Form section -->
    <div class="flex flex-col items-center relative top-1/2">
      <div class="mb-[10px]">
        <div class="text-[#169C89] font-medium text-[26px] leading-7">Регистрация</div>
        <div class="text-[#999999] text-[18px]">Создай аккаунт, чтобы пройти дальше.</div>
      </div>
      <div class="flex flex-col gap-y-[10px]">
        ...
        <div class="relative w-[343px]">
          ...
          <input
            type="text"
            placeholder="Имя"
            class="border-2 border-[#DDDDDD] w-[343px] h-[58px] bg-[#F8F8F8] rounded-[10px] pl-[48px] placeholder:text-[#C7C7C7] placeholder:leading-3"
          />
        </div>
        ...
        <div class="relative w-[343px]">
          ...
          <input
            ...
            placeholder="Пароль"
            class="border-2 border-[#DDDDDD] w-[343px] h-[58px] bg-[#F8F8F8] rounded-[10px] pl-[48px] pr-[48px] placeholder:text-[#C7C7C7] placeholder:leading-3"
          />
          <span
        ...
        <div class="relative w-[343px]">
          <span class="absolute left-4 top-1/2 transform -translate-y-1/2 text-[#C7C7C7]">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M12 17C11.4696 17 10.9609 16.7893 10.5858 16.4142C10.2107 16.0391 10 15.5304 10 15C10 13.89 10.89 13 12 13C12.5304 13 13.0391 13.2107 13.4142 13.5858C13.7893 13.9609 14 14.4696 14 15C14 15.5304 13.7893 16.0391 13.4142 16.4142C13.0391 16.7893 12.5304 17 12 17ZM18 20V10H6V20H18ZM18 8C18.5304 8 19.0391 8.21071 19.4142 8.58579C19.7893 8.96086 20 9.46957 20 10V20C20 20.5304 19.7893 21.0391 19.4142 21.4142C19.0391 21.7893 18.5304 22 18 22H6C5.46957 22 4.96086 21.7893 4.58579 21.4142C4.21071 21.0391 4 20.5304 4 20V10C4 8.89 4.89 8 6 8H7V6C7 4.67392 7.52678 3.40215 8.46447 2.46447C9.402-Christian 1.52678 10.6739 1 12 1C12.6566 1 13.3068 1.12933 13.9134 1.3806C14.52 1.63188 15.0712 2.00017 15.5355 2.46447C15.9998 2.92876 16.3681 3.47995 16.6194 4.08658C16.8707 4.69321 17 5.34339 17 6V8H18ZM12 3C11.2044 3 10.4413 3.31607 9.87868 3.87868C9.31607 4.44129 9 5.20435 9 6V8H15V6C15 5.20435 14.6839 4.44129 14.1213 3.87868C13.5587 3.31607 12.7956 3 12 3Z"
                fill="#B1B1B1"
              />
            </svg>
          </span>
        ...
        <!-- Register button -->
        <button
          class="bg-[#169C89] text-white w-[343px] h-[58px] text-[20px] mt-[20px] rounded-md"
        >
          Зарегистрироваться
        </button>
      </div>
    ...
    <!-- Footer -->
    <div
      class="absolute -bottom-20 bg-[#E8F3F2] w-full h-[80px] flex justify-center flex-row gap-2 items-center"
    >
      <div class="text-[#999999] text-[18px]">Уже есть аккаунт?</div>
      <router-link to="/login" class="text-[#169C89] text-[18px]">
        Войти
      </router-link>
    </div>
  </div>
